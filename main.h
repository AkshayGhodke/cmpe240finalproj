...
#define 	SECURITY_CODE				4										//	Buffer size for security code
#endif
// EEPROM Parameters
...
#define     ROOM_TEMP				0x36								// Room temp 1 (1 byte)
...
#define		SETTINGS_DATE_FG			"000000"
#define		SETTINGS_DATE_BG			"FFFFFF"
#define		SETTINGS_DATE_FONT			2
#define		SETTINGS_DATE_X				275
#define		SETTINGS_DATE_Y				410
...
//-------------------------------------------------------------------------------------------------------
// Project Function Protytypes
//-------------------------------------------------------------------------------------------------------
unsigned char celsiusToFahrenheit(unsigned char roomTemp);
